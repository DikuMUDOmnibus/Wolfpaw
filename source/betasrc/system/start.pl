...
$exec		=	"/home/mud/aota/aota/aoa/src/AOTA";

# Path where you want the mud logs to be kept.

$logdir		=	"/home/mud/aota/aota/aoa/log";

# Path where we should start the mud from.				#
$startPath	=	"/home/mud/aota/aota/aoa/area";
...
sub restart_mud {
		...
		chdir $startPath;
# CHANGE THIS!!!!!! --GW
		system ("/home/mud/aota/aota/aoa/system/startmud &");
		return;
}
